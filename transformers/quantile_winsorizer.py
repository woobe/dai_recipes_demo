## Original: https://github.com/h2oai/driverlessai-recipes/blob/master/transformers/outliers/quantile_winsorizer.py
...
class JoeSupaDupaQuantileWinsorizer(CustomTransformer):
    @staticmethod
    ...
    def display_name(self):
        return "JoeSupaDupaQuantileWinsorizer%s" % str(self._quantile)
