## Original https://github.com/h2oai/driverlessai-recipes/blob/master/transformers/numeric/log_transformer.py
...
class JoeSupaDupaLogTransformer(CustomTransformer):
    @staticmethod
